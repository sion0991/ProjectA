...
URPGAbilitySystemComponent* UAT_PlayMontageAndWaitForEvent::GetTargetASC()
{
...
void UAT_PlayMontageAndWaitForEvent::Activate()
{
	...
	if (RPGAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = RPGAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UAT_PlayMontageAndWaitForEvent::OnGameplayEvent));
